...
describe('v1beta1.CloudRedisClient', () => {
    ...
    describe('createInstance', () => {
        it('invokes createInstance without error', done => {
            ...
            client.createInstance(request).then((responses: [Operation]) => {
    ...
    describe('updateInstance', () => {
        it('invokes updateInstance without error', done => {
            ...
            client.updateInstance(request).then((responses: [Operation]) => {
                const operation = responses[0];
                return operation? operation.promise() : {};
            }).then((responses: [Operation]) => {
                assert.deepStrictEqual(responses[0], expectedResponse);
    ...
    describe('upgradeInstance', () => {
        it('invokes upgradeInstance without error', done => {
            ...
            client.upgradeInstance(request).then((responses: [Operation]) => {
                const operation = responses[0];
                return operation? operation.promise() : {};
            }).then((responses: [Operation]) => {
                assert.deepStrictEqual(responses[0], expectedResponse);
    ...
    describe('importInstance', () => {
        it('invokes importInstance without error', done => {
            ...
            client.importInstance(request).then((responses: [Operation]) => {
                const operation = responses[0];
                return operation? operation.promise() : {};
            }).then((responses: [Operation]) => {
                assert.deepStrictEqual(responses[0], expectedResponse);
    ...
    describe('exportInstance', () => {
        it('invokes exportInstance without error', done => {
            ...
            client.exportInstance(request).then((responses: [Operation]) => {
                const operation = responses[0];
                return operation? operation.promise() : {};
            }).then((responses: [Operation]) => {
                assert.deepStrictEqual(responses[0], expectedResponse);
    ...
    describe('failoverInstance', () => {
        it('invokes failoverInstance without error', done => {
            ...
            client.failoverInstance(request).then((responses: [Operation]) => {
                const operation = responses[0];
                return operation? operation.promise() : {};
            }).then((responses: [Operation]) => {
                assert.deepStrictEqual(responses[0], expectedResponse);
    ...
    describe('deleteInstance', () => {
        it('invokes deleteInstance without error', done => {
            ...
            client.deleteInstance(request).then((responses: [Operation]) => {
                const operation = responses[0];
                return operation? operation.promise() : {};
            }).then((responses: [Operation]) => {
                assert.deepStrictEqual(responses[0], expectedResponse);
