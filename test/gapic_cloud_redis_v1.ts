...
describe('v1.CloudRedisClient', () => {
    ...
    describe('importInstance', () => {
        ...
        it('invokes importInstance with call error', async () => {
            ...
            await assert.rejects(async () => { await client.importInstance(request); }, expectedError);
            assert((client.innerApiCalls.importInstance as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('exportInstance', () => {
        ...
        it('invokes exportInstance with call error', async () => {
            ...
            await assert.rejects(async () => { await client.exportInstance(request); }, expectedError);
            assert((client.innerApiCalls.exportInstance as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('failoverInstance', () => {
        ...
        it('invokes failoverInstance with call error', async () => {
            ...
            await assert.rejects(async () => { await client.failoverInstance(request); }, expectedError);
            assert((client.innerApiCalls.failoverInstance as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
