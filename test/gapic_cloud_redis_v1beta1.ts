...
describe('v1beta1.CloudRedisClient', () => {
    ...
    describe('upgradeInstance', () => {
        it('invokes upgradeInstance without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.redis.v1beta1.UpgradeInstanceRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
        ...
        it('invokes upgradeInstance with call error', async () => {
            ...
            await assert.rejects(async () => { await client.upgradeInstance(request); }, expectedError);
            assert((client.innerApiCalls.upgradeInstance as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
