...
export class CloudRedisClient {
  ...
  initialize() {
    ...
    const cloudRedisStubMethods =
        ['listInstances', 'getInstance', 'getInstanceAuthString', 'createInstance', 'updateInstance', 'upgradeInstance', 'importInstance', 'exportInstance', 'failoverInstance', 'deleteInstance'];
